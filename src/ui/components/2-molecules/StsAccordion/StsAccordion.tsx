  ...
  return (
    <div className="accordian">
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <ul>
            ...
            <li>
              <p>
                Få gratis tilpasning af dit produkt med i købet, hvis du kompenserer mere end 5%
              </p>
            </li>
          </ul>
        </AccordionDetails>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <p>
            Det er vigtig for os, at de produkter du køber, passer ind i din visuelle identitet, så
          ...
          <p>
            ...
            gratis tilpasning af dit produkt med i købet.
          </p>
        </AccordionDetails>
      </Accordion>
    </div>
